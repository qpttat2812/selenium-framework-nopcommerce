...
public class AddressPageUI {
	public static final String ADD_ADDRESS_BUTTON = "//button[contains(@class, 'add-address-button')]";
	...
	public static final String ADDRESS_I_TEXT = "//li[@class='address1']";
	public static final String ADDRESS_II_TEXT = "//li[@class='address2']";
